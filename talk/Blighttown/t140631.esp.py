...
class State_61(State):
    """61: Chaos Blade quest [prompt YES]"""
...
class State_62(State):
    """62: Chaos Blade quest [prompt NO]"""

    def previous_states(self):
        return [State_60]

    def enter(self):
        TalkToPlayer(conversation=41010900, unk1=-1, unk2=-1)
...
class State_63(State):
    """63: Chaos Blade quest [prompt YES, award]"""
...
class State_64(State):
    """64: Chaos Blade quest [prompt YES, end]"""

    def previous_states(self):
        return [State_6]

    def enter(self):
        TalkToPlayer(conversation=41010810, unk1=-1, unk2=-1)
