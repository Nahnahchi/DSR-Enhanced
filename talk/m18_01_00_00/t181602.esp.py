...
class State_10(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(talk_param_id=12000000, unk1=-1, unk2=-1)
...
class State_12(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(talk_param_id=12000203, unk1=-1, unk2=-1)
...
class State_13(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=12000300, unk1=-1, unk2=-1)
        DisplayOneLineHelp(text_id=-1)
        ForceCloseMenu()
...
class State_14(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(talk_param_id=12000120, unk1=-1, unk2=-1)
...
class State_21(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=12000100, unk1=-1, unk2=-1)
...
class State_23(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=12000200, unk1=-1, unk2=-1)
...
class State_25(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(talk_param_id=12000140, unk1=-1, unk2=-1)
...
class State_26(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(talk_param_id=12000009, unk1=-1, unk2=-1)
...
class State_29(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=12000500, unk1=-1, unk2=-1)
...
class State_30(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(talk_param_id=12000520, unk1=-1, unk2=-1)
