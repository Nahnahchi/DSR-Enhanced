...
class State_2(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000800, unk1=-1, unk2=-1)
...
class State_3(State):
    ...
    def enter(self):
        SetFlagState(flag=11015020, state=1)
...
class State_4(State):
    ...
    def previous_states(self):
        return [State_5, State_32, State_33]
...
class State_5(State):
    ...
    def previous_states(self):
        return [State_32, State_33, State_45]

    def enter(self):
        TalkToPlayer(talk_param_id=29000700, unk1=-1, unk2=-1)
...
class State_7(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001000, unk1=-1, unk2=-1)
        SetFlagState(flag=71010010, state=1)
        ForceCloseMenu()
...
class State_11(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000900, unk1=-1, unk2=-1)
        SetFlagState(flag=71010009, state=1)
        ForceCloseMenu()
...
class State_12(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000000, unk1=-1, unk2=-1)
        DisplayOneLineHelp(text_id=-1)
...
class State_13(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000100, unk1=-1, unk2=-1)
        DisplayOneLineHelp(text_id=-1)
...
class State_15(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000200, unk1=-1, unk2=-1)
...
class State_17(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000300, unk1=-1, unk2=-1)
...
class State_18(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000400, unk1=-1, unk2=-1)
...
class State_19(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000500, unk1=-1, unk2=-1)
...
class State_26(State):
    ...
    def previous_states(self):
        return [State_0, State_3, State_4, State_8, State_27, State_28, State_32, State_35, State_40, State_88, State_91, State_92, State_93, State_95]
    ...
    def test(self):
        if CheckSelfDeath() == 1 and GetFlagState(1322) == 0 and GetDistanceToPlayer() <= 5:
            return State_40
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(11015020) == 1 and GetFlagState(71010000) == 1:
            return State_2
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(71010000) == 0:
            return State_12
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 800) == 1:
            return State_48
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 801) == 1:
            return State_54
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 808) == 1:
            return State_60
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 809) == 1:
            return State_66
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 810) == 1:
            return State_72
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 802) == 1 and GetFlagState(71010012) == 0:
            return State_81
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 806) == 1 and GetFlagState(71010013) == 0:
            return State_82
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 807) == 1 and GetFlagState(71010014) == 0:
            return State_83
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 812) == 1 and GetFlagState(71010015) == 0:
            return State_84
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and IsEquipmentIDObtained(3, 813) == 1 and GetFlagState(71010016) == 0:
            return State_85
        if IsAttackedBySomeone() == 1 and GetFlagState(1322) == 0:
            return State_37
        if GetOneLineHelpStatus() == 0 and HasDisableTalkPeriodElapsed() == 1 and IsTalkingToSomeoneElse() == 0 and CheckSelfDeath() == 0 and IsCharacterDisabled() == 0 and IsClientPlayer() == 0 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetFlagState(1321) == 0 and GetFlagState(1322) == 0:
            return State_27
        if GetOneLineHelpStatus() == 1 and (IsTalkingToSomeoneElse() or CheckSelfDeath() or IsCharacterDisabled() or IsClientPlayer() == 1 or GetRelativeAngleBetweenPlayerAndSelf() > 45 or GetDistanceToPlayer() > 2):
            return State_28
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(71010000) == 1:
            return State_13
...
class State_29(State):
    ...
    def previous_states(self):
        return [State_24, State_30, State_31, State_36, State_39, State_42, State_43]
    ...
    def enter(self):
        ...
        AddTalkListData(menu_index=5, menu_text_id=15000010, required_flag=-1)
        AddTalkListData(menu_index=8, menu_text_id=15000350, required_flag=282)
        AddTalkListData(menu_index=6, menu_text_id=15000000, required_flag=-1)
        AddTalkListData(menu_index=7, menu_text_id=15000005, required_flag=-1)
    ...
    def test(self):
        ...
        if IsTalkingToSomeoneElse() or CheckSelfDeath() or IsCharacterDisabled() or IsClientPlayer() == 1 or GetRelativeAngleBetweenPlayerAndSelf() > 120 or GetDistanceToPlayer() > 3:
            return State_33
        if GetTalkListEntryResult() == 1 and GetFlagState(350) == 0 and GetFlagState(351) == 0 and GetFlagState(358) == 0 and GetFlagState(359) == 0 and GetFlagState(360) == 0:
            return State_98
...
class State_32(State):
    ...
    def previous_states(self):
        return [State_30, State_31, State_39, State_42, State_43, State_100]
...
class State_40(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001100, unk1=-1, unk2=-1)
        DisplayOneLineHelp(text_id=-1)
        ForceCloseMenu()
...
class State_48(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001200, unk1=-1, unk2=-1)
...
class State_50(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001400, unk1=-1, unk2=-1)
...
class State_51(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001300, unk1=-1, unk2=-1)
...
class State_54(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001450, unk1=-1, unk2=-1)
...
class State_56(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001470, unk1=-1, unk2=-1)
...
class State_57(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001460, unk1=-1, unk2=-1)
...
class State_60(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001500, unk1=-1, unk2=-1)
        DebugEvent(message='転職アイテム持ってた会話2')
        DisplayOneLineHelp(text_id=-1)
...
class State_62(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001700, unk1=-1, unk2=-1)
...
class State_63(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001600, unk1=-1, unk2=-1)
...
class State_66(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001800, unk1=-1, unk2=-1)
...
class State_68(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002000, unk1=-1, unk2=-1)
...
class State_69(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29001900, unk1=-1, unk2=-1)
...
class State_72(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002100, unk1=-1, unk2=-1)
...
class State_74(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002300, unk1=-1, unk2=-1)
...
class State_75(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002200, unk1=-1, unk2=-1)
...
class State_76(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000600, unk1=-1, unk2=-1)
...
class State_78(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002700, unk1=-1, unk2=-1)
...
class State_80(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002400, unk1=-1, unk2=-1)
...
class State_87(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29000950, unk1=-1, unk2=-1)
        SetFlagState(flag=71010011, state=1)
        ForceCloseMenu()
...
class State_88(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002500, unk1=-1, unk2=-1)
...
class State_91(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002600, unk1=-1, unk2=-1)
...
class State_93(State):
    ...
    def previous_states(self):
        return [State_25, State_32, State_33, State_95]
...
class State_96(State):
    ...
    def enter(self):
        TalkToPlayer(talk_param_id=29002800, unk1=-1, unk2=-1)
