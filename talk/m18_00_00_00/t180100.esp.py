...
class State_4(State):
    ...
    def enter(self):
        ...
        AddTalkListData(menu_index=6, menu_text_id=15000175, required_flag=702)
        ...
        AddTalkListData(menu_index=8, menu_text_id=10010744, required_flag=69696969)
...
class State_22(State):
    ...
    def enter(self):
        OpenMagicEquip(first_id=10000, last_id=10099)
