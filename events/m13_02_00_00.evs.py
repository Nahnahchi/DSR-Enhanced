...
def Event11320998():
    ...
    IfEntityWithinDistance(-1, 6286, PLAYER, radius=5.0)
    IfAttacked(-1, 6286, attacker=PLAYER)
...
@RestartOnRest
def Event11320850(_, arg_0_3: int, arg_4_7: int):
    """ 11320850: Event 11320850 """
...
def Event11320110():
    ...
    RunEvent(11325121)
    RunEvent(11325110, slot=0, args=(1, 0, 3530, 3530, 1320701, 91, 0, 0), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=1, args=(2, 0, 3531, 3531, 1320702, 92, 0, 1), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=2, args=(3, 0, 3532, 3532, 1320703, 93, 0, 2), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=3, args=(4, 0, 3533, 3533, 1320704, 94, 0, 3), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=4, args=(5, 0, 3534, 3534, 1320705, 95, 0, 4), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=5, args=(6, 0, 3535, 3535, 1320706, 96, 0, 5), arg_types="hhiiiBBi")
    RunEvent(11325110, slot=6, args=(8, 0, 3536, 3536, 1320707, 97, 0, 6), arg_types="hhiiiBBi")
...
def Event11325000():
    ...
    IfHost(1)
    IfEntityWithinDistance(1, 1320800, PLAYER, radius=30.0)
    IfConditionTrue(0, input_condition=1)
