...
def WT_BossBuff():
    ...
    AddSpecialEffect(1210800, 7101)
    AddSpecialEffect(1210801, 7101)
    AddSpecialEffect(1210802, 7101)
    AddSpecialEffect(1210820, 7101)
    AddSpecialEffect(1210840, 7101)
    AddSpecialEffect(1210400, 7101)
    AddSpecialEffect(1210401, 7101)
    AddSpecialEffect(6731, 7100)
    AddSpecialEffect(6732, 7100)
    AddSpecialEffect(6720, 7100)
    IfFlagOff(2, 11027997)
    IfConditionTrue(0, input_condition=2)
    CancelSpecialEffect(1210800, 7101)
    CancelSpecialEffect(1210801, 7101)
    CancelSpecialEffect(1210802, 7101)
    CancelSpecialEffect(1210820, 7101)
    CancelSpecialEffect(1210840, 7101)
    CancelSpecialEffect(1210400, 7101)
    CancelSpecialEffect(1210401, 7101)
    CancelSpecialEffect(6731, 7100)
    CancelSpecialEffect(6732, 7100)
    CancelSpecialEffect(6720, 7100)
    Restart()


@RestartOnRest
def Enemy_Dispose(_, arg_0_3: int, arg_4_7: int):
