...
from ..enums.m10_02_00_00_enums import *
...
def Constructor():
    ...
    Event_11020997()
    Event_11020998()
    RegisterBonfire(bonfire_flag=11020992, obj=Objects.o0200_0000, reaction_distance=1.0, initial_kindle_level=10)
    if FlagEnabled(11020108):
        RegisterBonfire(bonfire_flag=11020992, obj=Objects.o0200_0000, reaction_distance=1.0, initial_kindle_level=30)
    SkipLinesIfFlagDisabled(4, 11020300)
    SkipLinesIfFlagEnabled(2, 11020302)
    EndOfAnimation(obj=Objects.o1460_0000, animation_id=11)
    SkipLines(1)
    EndOfAnimation(obj=Objects.o1460_0000, animation_id=12)
    Event_11020999(0, class_type=0, obj=1021971)
    Event_11020999(1, class_type=1, obj=1021972)
    Event_11020999(2, class_type=2, obj=1021970)
    Event_11020999(3, class_type=3, obj=1021973)
    Event_11020999(4, class_type=4, obj=1021974)
    Event_11020999(5, class_type=5, obj=1021975)
    Event_11020999(6, class_type=6, obj=1021976)
    Event_11020999(7, class_type=7, obj=1021977)
    Event_11020999(8, class_type=8, obj=1021978)
    Event_11020999(9, class_type=9, obj=1021979)
    Event_11020300()
    Event_11025050()
    Event_11020001()
    Event_11020020()
    ...
    Event_11020106()
    Event_11020108()
    Event_11020120(0, obj_act_id=11020120, text=10010874, obj=Objects.o1465_0000, text_1=10010883, item=2015)
    Event_11020350()
    Event_11020351()
    Event_11020352()
    Event_11025150()
    Event_11020700(0, obj=Objects.o0110_0000, obj_act_id=11020700)
    Event_11020700(1, obj=Objects.o0110_0001, obj_act_id=11020701)
    Event_11020700(2, obj=Objects.o0110_0002, obj_act_id=11020702)
    Event_11020700(3, obj=Objects.o0110_0003, obj_act_id=11020703)
    Event_11025200(0, other_entity=Characters.c2900_0003, character=Characters.c2900_0003, radius=4.0, seconds=0.0)
    Event_11025200(
        1,
        other_entity=Characters.c2900_0003,
        character=Characters.c2900_0004,
        radius=4.0,
        seconds=0.8999999761581421,
    )
    Event_11025200(2, other_entity=Characters.c2900_0005, character=Characters.c2900_0005, radius=3.0, seconds=0.0)
    Event_11025200(
        3,
        other_entity=Characters.c2900_0005,
        character=Characters.c2900_0006,
        radius=3.0,
        seconds=0.699999988079071,
    )
    Event_11025200(6, other_entity=Characters.c2900_0000, character=Characters.c2900_0000, radius=11.0, seconds=0.0)
    Event_11025200(7, other_entity=Characters.c2900_0000, character=Characters.c2900_0001, radius=11.0, seconds=1.5)
    Event_11025200(8, other_entity=Characters.c2900_0002, character=Characters.c2900_0002, radius=7.0, seconds=0.0)
    Event_11025200(
        9,
        other_entity=Characters.c2900_0002,
        character=Characters.c2900_0014,
        radius=7.0,
        seconds=1.100000023841858,
    )
    Event_11025200(10, other_entity=Characters.c2900_0009, character=Characters.c2900_0009, radius=11.0, seconds=0.0)
    Event_11025200(
        11,
        other_entity=Characters.c2900_0009,
        character=Characters.c2900_0010,
        radius=11.0,
        seconds=0.800000011920929,
    )
    Event_11025200(12, other_entity=Characters.c2900_0009, character=Characters.c2900_0011, radius=11.0, seconds=1.5)
    Event_11025200(
        13,
        other_entity=Characters.c2900_0009,
        character=Characters.c2910_0000,
        radius=11.0,
        seconds=2.200000047683716,
    )
    Event_11025200(14, other_entity=Characters.c2910_0001, character=Characters.c2910_0001, radius=3.0, seconds=0.0)


@ContinueOnRest(11020996)
def Event_11020996():
    """Event 11020996"""
    MAIN.Await(FlagDisabled(742))
    
    DisableCharacter(Characters.c4171_hum1)


@ContinueOnRest(11020997)
def Event_11020997():
    """Event 11020997"""
    if ThisEventFlagEnabled():
        return
    AND_1.Add(CharacterInsideRegion(PLAYER, region=1022999))
...
@ContinueOnRest(11020998)
def Event_11020998():
    """Event 11020998"""
    if ThisEventSlotFlagEnabled():
        return
    AND_1.Add(FlagEnabled(11027998))
...
@ContinueOnRest(11020999)
def Event_11020999(_, class_type: uchar, obj: Object | int):
    """Event 11020999"""
    AND_1.Add(PlayerClass(class_type))
    if not AND_1:
        return
    DisableTreasure(obj=1021970)
    DisableTreasure(obj=1021971)
    DisableTreasure(obj=1021972)
    DisableTreasure(obj=1021973)
    DisableTreasure(obj=1021974)
    DisableTreasure(obj=1021975)
    DisableTreasure(obj=1021976)
    DisableTreasure(obj=1021977)
    DisableTreasure(obj=1021978)
    DisableTreasure(obj=1021979)
    DisableObject(1021970)
    DisableObject(1021971)
    DisableObject(1021972)
    DisableObject(1021973)
    DisableObject(1021974)
    DisableObject(1021975)
    DisableObject(1021976)
    DisableObject(1021977)
    DisableObject(1021978)
    DisableObject(1021979)
    EnableObject(obj)
    EnableTreasure(obj=obj)


@ContinueOnRest(11020899)
def Event_11020899(_, first_flag: Flag | int, last_flag: Flag | int):
    """Event 11020899"""
    if Client():
        return
    if FlagDisabled(11020898):
        EnableFlag(11020898)
        EndOfAnimation(obj=Objects.o0110_0004, animation_id=0)
    ...
    if FlagEnabled(11025300):
        ...
        EnableTreasure(obj=Objects.o0020_0000)
        EnableTreasure(obj=Objects.o0020_0001)
        EnableTreasure(obj=Objects.o0020_0002)
        EnableTreasure(obj=Objects.o0020_0003)
        EnableTreasure(obj=Objects.o0020_0004)
        EnableTreasure(obj=Objects.o0020_0005)
        EnableTreasure(obj=Objects.o0020_0006)
        EnableTreasure(obj=Objects.o0020_0007)
        EnableTreasureCollection(obj=Objects.o0020_0000)
        EnableTreasureCollection(obj=Objects.o0020_0001)
        EnableTreasureCollection(obj=Objects.o0020_0002)
        EnableTreasureCollection(obj=Objects.o0020_0003)
        EnableTreasureCollection(obj=Objects.o0020_0004)
        EnableTreasureCollection(obj=Objects.o0020_0005)
        EnableTreasureCollection(obj=Objects.o0020_0006)
        EnableTreasureCollection(obj=Objects.o0020_0007)
...
def Preconstructor():
    ...
    Event_11020800(70, right=11017210, flag=703, item_type=3, item=385, flag_1=50004070)
    Event_11020899(0, first_flag=50004000, last_flag=50004070)
    HumanityRegistration(Characters.c0000_0011, event_flag=8334)
    SkipLinesIfFlagEnabled(2, 1092)
    SkipLinesIfFlagEnabled(1, 1096)
    DisableCharacter(Characters.c0000_0011)
    Event_11020510(0, character=Characters.c0000_0011, flag=1096)
    Event_11020530(0, character=Characters.c0000_0011, first_flag=1090, last_flag=1109, flag=1097)
    Event_11020550(0, character=Characters.c0000_0011, first_flag=1090, last_flag=1109, flag=1092)
    Event_11020551(0, character=Characters.c0000_0011, first_flag=1090, last_flag=1109, flag=1093)
    HumanityRegistration(Characters.c0000_0012, event_flag=8342)
    SkipLinesIfFlagRangeAnyEnabled(1, (1112, 1114))
    DisableCharacter(Characters.c0000_0012)
    Event_11020510(1, character=Characters.c0000_0012, flag=1114)
    Event_11020530(1, character=Characters.c0000_0012, first_flag=1110, last_flag=1119, flag=1115)
    Event_11020552(0, character=Characters.c0000_0012, first_flag=1110, last_flag=1119, flag=1112)
    Event_11020553(0, character=Characters.c0000_0012, first_flag=1110, last_flag=1119, flag=1113)
    Event_11020554(0, character=Characters.c0000_0012, first_flag=1110, last_flag=1119, flag=1117)
    Event_11020110()
    Event_11020555(0, character=Characters.c2750_0000, first_flag=1140, last_flag=1169, flag=1141)
    Event_11020556(0, character=Characters.c2750_0000, first_flag=1140, last_flag=1169, flag=1146)
    Event_11020557(0, character=Characters.c2750_0000, first_flag=1140, last_flag=1169, flag=1142)
    Event_11020558(0, character=Characters.c2750_0000, first_flag=1140, last_flag=1169, flag=1145)
    HumanityRegistration(Characters.c0000_0013, event_flag=8358)
    if FlagDisabled(1171):
        DisableCharacter(Characters.c0000_0013)
    Event_11020501()
    Event_11020559()
    Event_11020560()
    Event_11020530(2, character=Characters.c0000_0013, first_flag=1170, last_flag=1180, flag=1177)
    HumanityRegistration(Characters.c0000_0014, event_flag=8366)
    SkipLinesIfFlagEnabled(1, 1192)
    SkipLines(1)
    DisableCharacter(Characters.c0000_0014)
    Event_11020564(0, character=Characters.c0000_0014, first_flag=1190, last_flag=1209, flag=1193)
    Event_11020565(0, character=Characters.c0000_0014, first_flag=1190, last_flag=1209, flag=1194)
    Event_11020502(0, character=Characters.c0000_0014, flag=1197)
    Event_11020503(0, character=Characters.c0000_0014, flag=1195)
    Event_11020569(0, character=Characters.c0000_0014, first_flag=1190, last_flag=1209, flag=1198)
    Event_11020567(0, character=Characters.c0000_0014, first_flag=1190, last_flag=1209, flag=1196)
    HumanityRegistration(Characters.c0000_0015, event_flag=8374)
    if FlagDisabled(1211):
        DisableCharacter(Characters.c0000_0015)
    Event_11020530(4, character=Characters.c0000_0015, first_flag=1210, last_flag=1219, flag=1214)
    HumanityRegistration(Characters.c0000_0016, event_flag=8382)
    if FlagDisabled(1221):
        DisableCharacter(Characters.c0000_0016)
    Event_11020530(5, character=Characters.c0000_0016, first_flag=1220, last_flag=1229, flag=1224)
    HumanityRegistration(Characters.c0000_0017, event_flag=CommonFlags.LaurentiusHumanityFlag)
    SkipLinesIfFlagEnabled(2, 1252)
    SkipLinesIfFlagEnabled(1, 1253)
    DisableCharacter(Characters.c0000_0017)
    Event_11020510(6, character=Characters.c0000_0017, flag=1253)
    Event_11020530(6, character=Characters.c0000_0017, first_flag=1250, last_flag=1259, flag=1254)
    Event_11020574(0, character=Characters.c0000_0017, first_flag=1250, last_flag=1259, flag=1252)
    Event_11020575(0, character=Characters.c0000_0017, first_flag=1250, last_flag=1259, flag=1256)
    HumanityRegistration(Characters.c0000_0024, event_flag=8406)
    SkipLinesIfFlagEnabled(2, 1314)
    SkipLinesIfFlagEnabled(1, 1313)
    DisableCharacter(Characters.c0000_0024)
    Event_11020510(7, character=Characters.c0000_0024, flag=1314)
    Event_11020530(7, character=Characters.c0000_0024, first_flag=1310, last_flag=1319, flag=1315)
    Event_11020576(0, character=Characters.c0000_0024, first_flag=1310, last_flag=1319, flag=1313)
    Event_11020504(8, character=Characters.c2510_0000, flag=1411)
    Event_11020530(8, character=Characters.c2510_0000, first_flag=1410, last_flag=1413, flag=1412)
    HumanityRegistration(Characters.c0000_0003, event_flag=CommonFlags.DomnhallHumanityFlag)
    SkipLinesIfFlagEnabled(2, 1434)
    SkipLinesIfFlagEnabled(1, 1431)
    DisableCharacter(Characters.c0000_0003)
    Event_11020510(9, character=Characters.c0000_0003, flag=1434)
    Event_11020413(0, character=Characters.c0000_0003, flag=1435)
    Event_11020412(0, character=Characters.c0000_0003, first_flag=1430, last_flag=1459, flag=1431)
    HumanityRegistration(Characters.c0000_0018, event_flag=8438)
    SkipLinesIfFlagEnabled(2, 1464)
    SkipLinesIfFlagEnabled(1, 1462)
    SkipLines(1)
    DisableCharacter(Characters.c0000_0018)
    Event_11020510(10, character=Characters.c0000_0018, flag=1461)
    Event_11020530(10, character=Characters.c0000_0018, first_flag=1460, last_flag=1464, flag=1462)
    Event_11020577(0, character=Characters.c0000_0018, first_flag=1460, last_flag=1464, flag=1464)
    HumanityRegistration(Characters.c0000_0020, event_flag=8446)
    SkipLinesIfFlagEnabled(2, 1512)
    SkipLinesIfFlagEnabled(1, 1497)
    DisableCharacter(Characters.c0000_0020)
    Event_11020510(11, character=Characters.c0000_0020, flag=1512)
    Event_11020530(11, character=Characters.c0000_0020, first_flag=1490, last_flag=1514, flag=1513)
    Event_11020579(0, character=Characters.c0000_0020, first_flag=1490, last_flag=1514, flag=1497)
    HumanityRegistration(Characters.c0000_0021, event_flag=8454)
    ...
    Event_11020510(12, character=Characters.c0000_0021, flag=1547)
    Event_11020530(12, character=Characters.c0000_0021, first_flag=1540, last_flag=1569, flag=1548)
    Event_11020583(0, character=Characters.c0000_0021, first_flag=1540, last_flag=1569, flag=1543)
    Event_11020584(0, character=Characters.c0000_0021, first_flag=1540, last_flag=1569, flag=1544)
    Event_11020585(0, character=Characters.c0000_0021, first_flag=1540, last_flag=1569, flag=1545)
    Event_11020586(0, character=Characters.c0000_0021)
    HumanityRegistration(Characters.c0000_0019, event_flag=CommonFlags.LautrecHumanityFlag)
    ...
    Event_11020510(13, character=Characters.c0000_0019, flag=1574)
    Event_11020530(13, character=Characters.c0000_0019, first_flag=1570, last_flag=1599, flag=1575)
    Event_11020587(0, character=Characters.c0000_0019, first_flag=1570, last_flag=1599, flag=1572)
    if FlagEnabled(11020690):
        Event_11020588(
            0,
            character=Characters.c0000_0019,
            first_flag=1570,
            last_flag=1599,
            flag=1573,
            flag_1=1572,
    ...
    Event_11020589(0, character=Characters.c0000_0019, first_flag=1570, last_flag=1599, flag=1577)
    Event_11020410(0, character=Characters.c0000_0019, first_flag=1570, last_flag=1599, flag=1578)
    HumanityRegistration(Characters.c0000_0022, event_flag=8478)
    SkipLinesIfFlagEnabled(2, 1627)
    SkipLinesIfFlagEnabled(1, 1626)
    DisableCharacter(Characters.c0000_0022)
    Event_11020510(14, character=Characters.c0000_0022, flag=1627)
    Event_11020530(14, character=Characters.c0000_0022, first_flag=1620, last_flag=1629, flag=1628)
    Event_11020411(0, character=Characters.c0000_0022, first_flag=1620, last_flag=1629, flag=1626)
    SkipLinesIfFlagDisabled(2, CommonFlags.GwynLordOfCinderDead)
    DisableCharacter(Characters.c5330_0000)
    SkipLinesIfFlagEnabled(14, CommonFlags.GwynLordOfCinderDead)
    ...
    SkipLines(1)
    DisableCharacter(Characters.c5330_0000)
    Event_11020420(0, character=Characters.c5330_0000, first_flag=1640, last_flag=1649, flag=1641)
    Event_11020421(0, character=Characters.c5330_0000, first_flag=1640, last_flag=1649, flag=1642)
    Event_11020422(0, character=Characters.c5330_0000, first_flag=1640, last_flag=1649, flag=1643)
    Event_11020423(0, character=Characters.c5330_0000, first_flag=1640, last_flag=1649, flag=1644)
    Event_11020424(0, character=Characters.c5330_0000, first_flag=1640, last_flag=1649, flag=1647)
    Event_11020425(0, character=Characters.c5330_0000, first_flag=1640, last_flag=1649, flag=1647)
    Event_11026200()
    Event_11026210()
...
def Event_11025050():
    ...
    MAIN.Await(HealthRatio(Characters.c3510_0000) <= 0.30000001192092896)
...
def Event_11020001():
    ...
    DisableSoundEvent(sound_id=Sounds.FirelinkShrineMusic)
    
    MAIN.Await(FlagEnabled(CommonFlags.TutorialComplete))
    
    EnableSoundEvent(sound_id=Sounds.FirelinkShrineMusic)
    EnableFlag(11020001)
    Wait(3.0)
...
def Event_11025200(_, other_entity: int, character: Character | int, radius: float, seconds: float):
    """Event 11025200"""
    if ThisEventSlotFlagEnabled():
...
def Event_11020105():
    """Event 11020105"""
    DisableTreasure(obj=Objects.o1475_0000)
    ...
    if FlagDisabled(11020101):
        ...
        EnableFlag(102)
        EnableTreasure(obj=Objects.o1475_0000)
...
def Event_11020350():
    ...
    if ThisEventFlagDisabled():
        ...
        DisableMapCollision(collision=Collisions.h0105B2_0000)
        AND_1.Add(FlagEnabled(11010700))
        AND_1.Add(FlagEnabled(11400200))
        ...
        EnableMapCollision(collision=Collisions.h0105B2_0000)
    DisableObject(Objects.o1480_0000)
    DisableMapCollision(collision=Collisions.h0005B2_0000)
    DisableMapPiece(map_piece_id=MapPieces.m2022B2_0000)
    DisableMapCollision(collision=Collisions.h7000B2_0000)
...
def Event_11020351():
    ...
    if FlagDisabled(CommonFlags.BonfireWarpOptionDisplayed):
        Kill(PLAYER)
        End()
...
def Event_11020352():
    ...
    DisableMapCollision(collision=Collisions.h8100B2_0000)
    DisableMapCollision(collision=Collisions.h8100B2_0001)


@ContinueOnRest(11020700)
def Event_11020700(_, obj: Object | int, obj_act_id: int):
    """Event 11020700"""
    if ThisEventSlotFlagEnabled():
...
def Event_11025150():
    ...
    AICommand(Characters.c2550_0000, command_id=1, command_slot=3)
    AICommand(Characters.c2540_0000, command_id=1, command_slot=3)
    AICommand(Characters.c2540_0001, command_id=1, command_slot=3)
    AICommand(Characters.c2540_0003, command_id=1, command_slot=3)
    AICommand(Characters.c2540_0006, command_id=1, command_slot=3)
    AICommand(Characters.c2540_0007, command_id=1, command_slot=3)
...
def Event_11020510(_, character: Character | int, flag: Flag | int):
    """Event 11020510"""
...
def Event_11020530(_, character: int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020530"""
    if FlagEnabled(flag):                                            # Ingward fix
    ...
    AND_3.Add(InsideMap(game_map=FIRELINK_SHRINE))                    # Ingward fix
...
def Event_11020501():
    ...
    AND_3.Add(HealthRatio(Characters.c0000_0014) <= 0.8999999761581421)
    if FlagDisabled(1198):
        AND_3.Add(Attacked(attacked_entity=Characters.c0000_0014, attacker=PLAYER))
    AND_4.Add(HealthRatio(Characters.c0000_0015) <= 0.8999999761581421)
    if FlagDisabled(1214):
        AND_4.Add(Attacked(attacked_entity=Characters.c0000_0015, attacker=PLAYER))
    AND_5.Add(HealthRatio(Characters.c0000_0016) <= 0.8999999761581421)
    if FlagDisabled(1224):
        AND_5.Add(Attacked(attacked_entity=Characters.c0000_0016, attacker=PLAYER))
...
def Event_11020502(_, character: Character | int, flag: Flag | int):
    """Event 11020502"""
    AND_7.Add(FlagDisabled(CommonFlags.CapraDemonDead))
    AND_7.Add(FlagDisabled(1195))
    AND_7.Add(FlagDisabled(1197))
    AND_7.Add(FlagEnabled(1202))
    AND_6.Add(FlagEnabled(CommonFlags.CapraDemonDead))
...
def Event_11020503(_, character: Character | int, flag: Flag | int):
    """Event 11020503"""
...
def Event_11020504(_, character: int, flag: Flag | int):
    """Event 11020504"""
...
def Event_11020550(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020550"""
...
def Event_11020551(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020551"""
    AND_1.Add(FlagDisabled(1096))
    AND_1.Add(FlagDisabled(1099))
...
def Event_11020552(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020552"""
...
def Event_11020553(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020553"""
    AND_1.Add(FlagDisabled(1114))
    AND_1.Add(FlagDisabled(1117))
...
def Event_11020554(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020554"""
    AND_1.Add(FlagDisabled(1114))
    AND_1.Add(FlagDisabled(1117))
...
def Event_11020555(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020555"""
...
def Event_11020556(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020556"""
...
def Event_11020557(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020557"""
...
def Event_11020558(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020558"""
...
def Event_11020564(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020564"""
...
def Event_11020565(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020565"""
    AND_1.Add(FlagDisabled(1195))
    AND_1.Add(FlagDisabled(1197))
...
def Event_11020567(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020567"""
...
def Event_11020569(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020569"""
...
def Event_11020574(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020574"""
...
def Event_11020575(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020575"""
    AND_1.Add(FlagDisabled(1253))
...
@RestartOnRest(11020576)
def Event_11020576(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020576"""
    DisableCharacter(character)
    AND_1.Add(FlagDisabled(flag))
...
def Event_11020577(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020577"""
...
def Event_11020579(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020579"""
...
def Event_11020583(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020583"""
...
def Event_11020584(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020584"""
    AND_1.Add(FlagDisabled(1547))
...
def Event_11020585(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020585"""
    AND_1.Add(FlagDisabled(1547))
...
def Event_11020586(_, character: Character | int):
    """Event 11020586"""
    AND_1.Add(FlagDisabled(1547))
...
def Event_11020587(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020587"""
    AND_1.Add(FlagDisabled(1574))
...
def Event_11020589(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020589"""
    AND_1.Add(FlagDisabled(1574))
    AND_1.Add(FlagDisabled(1578))
...
def Event_11020410(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020410"""
    AND_1.Add(FlagDisabled(1574))
    AND_1.Add(FlagDisabled(1578))
...
def Event_11020411(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020411"""
    ...
    AND_1.Add(FlagEnabled(CommonFlags.NitoDead))
    AND_1.Add(InsideMap(game_map=FIRELINK_SHRINE))
...
def Event_11020412(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020412"""
...
def Event_11020413(_, character: Character | int, flag: Flag | int):
    """Event 11020413"""
    if ThisEventFlagEnabled():
        DropMandatoryTreasure(character)
        End()
...
def Event_11020420(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020420"""
...
def Event_11020421(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020421"""
...
def Event_11020422(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020422"""
...
def Event_11020423(_, character: Character | int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020423"""
...
def Event_11020424(_, character: int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020424"""
...
def Event_11020425(_, character: int, first_flag: Flag | int, last_flag: Flag | int, flag: Flag | int):
    """Event 11020425"""
    AND_1.Add(InsideMap(game_map=FIRELINK_SHRINE))
...
def Event_11026210():
    ...
    DisableFlag(1650)
    AND_1.Add(InsideMap(game_map=FIRELINK_SHRINE))
    AND_1.Add(EntityBeyondDistance(entity=Characters.c5330_0000, other_entity=PLAYER, radius=30.0))
    ...
    MAIN.Await(Attacked(attacked_entity=Characters.c5330_0000, attacker=PLAYER))
...
def Event_11020110():
    ...
    EzstateAIRequest(Characters.c2750_0000, command_id=1702, command_slot=0)
    EnableFlag(11020100)
    if FlagDisabled(11020111):
        MAIN.Await(FlagEnabled(11020609))
    
        EzstateAIRequest(Characters.c2750_0000, command_id=1701, command_slot=0)
        EnableFlag(11020111)
    
        MAIN.Await(CharacterHasTAEEvent(Characters.c2750_0000, tae_event_id=1701))
    EnableFlag(11020101)
